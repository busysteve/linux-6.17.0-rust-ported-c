 ...
 * Original Rust version: /home/smathews/distro-rustfree/linux/drivers/gpu/nova-core/fb.rs
 */
...
{
    pr_info("fb module loaded (C port)\n");
    return 0;
}

static void __exit fb_exit(void)
{
    pr_info("fb module unloaded\n");
}

module_init(fb_init);
module_exit(fb_exit);

MODULE_DESCRIPTION("C port of fb Rust module");
